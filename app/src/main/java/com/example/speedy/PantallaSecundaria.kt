...
class PantallaSecundaria : AppCompatActivity() {
    ...
    private fun calculateSpeedy(){
        ...
        binding.resultsTV.text = String.format("Tasa metabolica basal de Hombre: %.2f", speedy)
        binding.healthyTV.text = String.format("Tasa metabolica basal de Mujer: %.2f", speedy2)
